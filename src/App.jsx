...
function App() {
  ...
  return <main>
    ...
    <section className="download wrap" id="download"><div className="download-card"><div className="download-copy"><span className="kicker light">Ready when you are</span><h2>Take your next word<br/>for a hop.</h2><p>Download Spellaroo for free and make spelling the best ten minutes of the day.</p><div className="store-buttons"><a className={platform === 'iPhone' ? 'recommended' : ''} href="/downloads/Spellaroo.ipa" download><Icon name="apple" size={27}/><span><small>Download for</small><b>iPhone & iPad</b></span></a><a className={platform === 'Android' ? 'recommended' : ''} href="/downloads/Spellaroo.apk" download><Icon name="android" size={27}/><span><small>Download for</small><b>Android</b></span></a></div><small className="platform-note">We think you're on {platform}. The preview download includes early-access instructions.</small></div><div className="phone"><div className="phone-screen"><div className="phone-logo"><span>S</span> Spellaroo</div><div className="mini-progress">TODAY'S WORDS <b>4 / 5</b></div><div className="mini-word"><span>S</span><span>M</span><span>I</span><span>L</span><span>E</span></div><strong>Brilliant!</strong><p>You found the word.</p><button>Next word →</button></div></div></div></section>
