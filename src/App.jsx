...
const Icon = ({ name, size = 20 }) => {
  const icons = {
    ...
    safari: <><circle cx="12" cy="12" r="10"/><path d="m16.24 7.76-2.12 6.36-6.36 2.12 2.12-6.36 6.36-2.12Z"/></>,
    share: <><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" y1="2" x2="12" y2="15"/></>,
    homescreen: <><rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><path d="M17.5 14v7M14 17.5h7"/></>,
    addcircle: <><circle cx="12" cy="12" r="10"/><path d="M8 12h8M12 8v8"/></>,
  }
...
function App() {
  ...
  const openIOSInstall = () => { setShowIOSInstallModal(true) }
  const closeIOSInstall = () => { setShowIOSInstallModal(false) }
  const openSpellaroo = () => { window.open('https://spellaroo.pages.dev/', '_blank'); setShowIOSInstallModal(false) }
  ...
  return <main>
    ...
    {showIOSInstallModal && <div className="modal-overlay ios-sheet-overlay" onClick={closeIOSInstall}><div className="ios-sheet" onClick={e => e.stopPropagation()}><div className="ios-sheet-handle"/><div className="ios-sheet-icon"><img src={appIcon} alt="Spellaroo" width="60" height="60"/></div><h3 className="ios-sheet-title">Spellaroo</h3><p className="ios-sheet-subtitle">Install this web app on your iPhone or iPad for the full experience.</p><div className="ios-grouped-list"><div className="ios-group"><div className="ios-row"><div className="ios-row-icon"><Icon name="safari" size={20}/></div><div className="ios-row-text"><span className="ios-row-label">Open in Safari</span><span className="ios-row-hint">Tap the button below to visit Spellaroo</span></div><span className="ios-row-num">1</span></div><div className="ios-separator"/><div className="ios-row"><div className="ios-row-icon ios-row-icon--blue"><Icon name="share" size={20}/></div><div className="ios-row-text"><span className="ios-row-label">Tap the Share button</span><span className="ios-row-hint">The square icon with an arrow ↑</span></div><span className="ios-row-num">2</span></div><div className="ios-separator"/><div className="ios-row"><div className="ios-row-icon ios-row-icon--green"><Icon name="homescreen" size={20}/></div><div className="ios-row-text"><span className="ios-row-label">Add to Home Screen</span><span className="ios-row-hint">Scroll down and tap this option</span></div><span className="ios-row-num">3</span></div><div className="ios-separator"/><div className="ios-row"><div className="ios-row-icon ios-row-icon--purple"><Icon name="addcircle" size={20}/></div><div className="ios-row-text"><span className="ios-row-label">Tap "Add"</span><span className="ios-row-hint">Spellaroo appears on your Home Screen</span></div><span className="ios-row-num">4</span></div></div></div><div className="ios-sheet-actions"><button className="ios-sheet-btn ios-sheet-btn--primary" onClick={openSpellaroo}>Open in Safari <Icon name="arrow" size={16}/></button><button className="ios-sheet-btn ios-sheet-btn--cancel" onClick={closeIOSInstall}>Not Now</button></div></div></div>}
